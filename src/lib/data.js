...
export const I18N = {
  fa: {
    ...
    nav: { dashboard: "داشبورد", businesses: "کسب‌وکارها", tasks: "کارها", requests: "درخواست‌ها", finance: "مالی", sheets: "جدول‌ها", diagram: "دیاگرام", employees: "کارمندان", projects: "پروژه‌ها", meetings: "جلسات", payroll: "حقوق و دستمزد", teams: "تیم‌ها", activity: "فعالیت‌ها" },
    ...
    titles: { dashboard: "داشبورد", businesses: "کسب‌وکارها", tasks: "کارها", requests: "درخواست‌ها", finance: "مالی", sheets: "جدول‌ها", diagram: "دیاگرام جریان داده", employees: "کارمندان", projects: "پروژه‌ها", meetings: "جلسات", payroll: "حقوق و دستمزد", teams: "تیم‌ها", activity: "فعالیت و دسترسی" },
    subs: { dashboard: "نمای کلی کسب‌وکار شما", businesses: "همه‌ی کسب‌وکارهات رو یکجا مدیریت کن", tasks: "کارهایی که باید انجام بدی", requests: "درخواست‌های تیم از طریقِ فرمِ اشتراکی", finance: "درآمد و هزینه‌ی هر کسب‌وکار", sheets: "جدول‌های ساده‌ی خودت رو بساز", diagram: "دیاگرام DFD رو بکش", employees: "مدیریت تیم و اطلاعات کارکنان", projects: "پروژه‌های جاری و وضعیتشان", meetings: "جلسات پیش‌رو", payroll: "پرداخت حقوق و یادآوری‌ها", teams: "دسته‌بندی تیم‌ها", activity: "چه کسی آنلاین است و چه چیزی تغییر کرده" },
  ...
  en: {
    ...
    nav: { dashboard: "Dashboard", businesses: "Businesses", tasks: "Tasks", requests: "Requests", finance: "Finance", sheets: "Tables", diagram: "Diagram", employees: "Employees", projects: "Projects", meetings: "Meetings", payroll: "Payroll", teams: "Teams", activity: "Activity" },
    ...
    titles: { dashboard: "Dashboard", businesses: "Businesses", tasks: "Tasks", requests: "Requests", finance: "Finance", sheets: "Tables", diagram: "Data Flow Diagram", employees: "Employees", projects: "Projects", meetings: "Meetings", payroll: "Payroll", teams: "Teams", activity: "Activity & Access" },
    subs: { dashboard: "Overview of your business", businesses: "Manage all your businesses in one place", tasks: "Things to do", requests: "Requests from your team via the shared form", finance: "Income & outgoing per business", sheets: "Build your own simple tables", diagram: "Draw your DFD", employees: "Manage your team & staff info", projects: "Ongoing projects & status", meetings: "Upcoming meetings", payroll: "Salary payments & reminders", teams: "Team grouping", activity: "Who's online and what changed" },
